...
const endpoints: Endpoints = {
  AllCategories: '/listing/allcategories',
  CategoryCard: '/block/categorycard/{key}',
  CategoryDetail: '/block/categorydetail/{key}',
  CategoryProducts: '/listing/categoryproducts',
  CmsPage: '/block/cmspage/{key}',
  FeaturedCategories: '/listing/featuredcategories',
  FeaturedProducts: '/listing/featuredproducts',
  FurnitureProductCard: '/block/furnitureproductcard/{key}',
  FurnitureProducts: '/listing/furnitureproducts',
  ProductCard: '/block/productcard/{key}',
  ProductDetail: '/block/productdetail/{key}',
}
...
const servers = [
  { description: 'Public frontstack Environment', url: 'https://fetch-0eebd5295bfb29f41b79fe15097107.frontstack.dev' },
]
